...
const textFields = ({ usernameValue, passwordValue, repeatPasswordValue }, usernameHandleChange, passwordHandleChange, repeatPasswordHandleChange) => (
  ...
  { key: '3', type: 'password', value: repeatPasswordValue, placeHolder: 'Repeat password', onChange: repeatPasswordHandleChange }]
)

const validateUserPassword = (user, password) => {
  const { users } = GET_DATA_LOCALSTORAGE()
  console.log('rere', GET_DATA_LOCALSTORAGE())
